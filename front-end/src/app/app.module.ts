...
import { ProductFormComponent } from './componants/product-form/product-form.component';
...
export const routes: Routes = [
  ...
  {path: 'payment', component: PaymentComponent , canActivate: [ScreenActivator]},
  {path: 'product/create', component: ProductFormComponent  , canActivate: [ScreenActivator]},
  {path: 'product/update/:id', component: ProductFormComponent  , canActivate: [ScreenActivator]},
  {path: 'orders', component: OrderDetailsComponent  , canActivate: [ScreenActivator]},
  {path: 'login', component: LoginComponent, canActivate: [LoginActivator]},
  {path: 'signup', component: RegisterComponent, canActivate: [LoginActivator]},
  // http://localhost:4200/
